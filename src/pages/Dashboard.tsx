                ...
                {filtered.length === 0 ? (
                  <div className="py-12 text-center">
                    ...
                    <button
                      ...
                      className="mt-3 text-accent label-uppercase text-[10px] flex items-center gap-1 mx-auto"
                    >
      ...
      <section className="px-5 mt-8 space-y-1 animate-fade-up" style={{ animationDelay: "0.2s" }}>
        ...
        {[
          ...
          <button
            key={label}
            onClick={action}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm active:scale-[0.98] transition-transform ${
